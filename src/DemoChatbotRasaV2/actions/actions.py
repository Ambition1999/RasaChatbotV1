...
# CONNECT TO SQLITE
sqliteConnection = sqlite3.connect(r'C:\Users\toan.le\Documents\GitHub\RasaChatbotV1\src\DemoChatbotRasaV2\testrasa.db')
                        ...
                        "buttons": [
                            {
                                "title": "View more",
                                "type": "postback",
                                "payload": "fire safety and protection equipment items"
                            }
                        ]
                      },
                      {
...
class ActionAskFindProtectionEquipmentItems(Action):

    def name(self) -> Text:
        return "action_answer_find_protection_equipment_items"
